...
`src/extension.ts` is the entry point. It wires together these components:
...
One runtime dependency: `js-yaml` for YAML parsing in diagnostics and template intelligence.
